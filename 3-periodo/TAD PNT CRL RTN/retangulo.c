...
{
    printf("pie: %s, pid: %s, psd: %s, pse: %s",pto_getPonto(R->pie), pto_getPonto(R->pid), pto_getPonto(R->psd), pto_getPonto(R->pse));
}
...
char* rtg_getRetangulo (Retangulo* R)
{
    ...
    sprintf(ret, "pie: %s, pid: %s, psd: %s, pse: %s", pto_getPonto(R->pie), pto_getPonto(R->pid), pto_getPonto(R->psd), pto_getPonto(R->pse));
